...
namespace WebbanBALO.Areas.Admin.Controllers
{
    public class SaleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Masale,Tenspsale,Giasale,Anhsp")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Masale,Tenspsale,Giasale,Anhsp")] Sale sale)
        {
            if (ModelState.IsValid)
            {
